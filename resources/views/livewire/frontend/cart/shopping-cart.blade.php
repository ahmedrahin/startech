                ...
                <div class="item">
                    <div class="image">
                       <a href="{{ route('product-details', $item['slug']) }}" >
                            <img src="{{ asset($item['image_url']) }}" width="47" height="47"></div>
                       </a>
                    <div class="info">
                        <div class="name">
                        ...
                        <span class="eq">=</span>
                        <span class="total" style="color:#ef4a23;">{{ $item['offer_price'] * $item['quantity'] }}৳</span>
                    </div>
    ...
    <div class="footer">
        ...
        <div class="checkout-btn">
            ...
            @elseif( config('website_settings.guest_checkout') == 0 && !Auth::check() )
                <button class="btn submit" onclick="message('warning', 'Please log in at first to checkout')">Checkout</button>
            @else
                <a href="{{route('checkout')}}">
                    <button class="btn submit">Checkout</button>
                </a>
