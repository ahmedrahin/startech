...
<div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
    <a href="{{ route('admin-management.admin-list.show', $user->id) }}" target="_blank">
        @php
...
<div class="d-flex flex-column">
    <a href="{{ route('admin-management.admin-list.show', $user->id) }}" class="text-gray-800 text-hover-primary" target="_blank">
        {{ $user->name }}
    </a>
