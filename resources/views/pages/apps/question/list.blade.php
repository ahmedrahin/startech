<x-default-layout>
    ...
    @section('title') Product Questions @endsection
        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar">
                <div class="d-flex justify-content-end" data-kt-product-table-toolbar="base">
                    ...
                    <div class="btn-group">
                        <a href="{{ route('question.weekly') }}" class="btn {{ request()->routeIs('question.weekly') ? 'btn-success' : 'btn-primary' }}">
                            This Week Questions
                        </a>

                        <a href="{{ route('question.product') }}" class="btn {{ request()->routeIs('question.product') ? 'btn-success' : 'btn-primary' }}">
                            All Questions
                        </a>
                    </div>
                </div>
